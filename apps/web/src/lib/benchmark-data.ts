...
export const BENCHMARK_MODELS: BenchModel[] = [
  { name: 'Claude Opus 4.8', vendor: 'claude', intelligence: 61, speed: 64, price: 4.1, coding: 88.6 },
  { name: 'GPT-5.5', vendor: 'gpt', intelligence: 59, speed: 70, price: 4.35, coding: 85.0 },
  { name: 'Claude Opus 4.7', vendor: 'claude', intelligence: 57, speed: 50, price: 4.1, coding: 87.6 },
  { name: 'Gemini 3.1 Pro', vendor: 'gemini', intelligence: 57, speed: 138, price: 1.74, coding: 80.6 },
  { name: 'Qwen3.7 Max', vendor: 'open', intelligence: 57, speed: 167, price: 1.43, coding: null },
  { name: 'Gemini 3.5 Flash', vendor: 'gemini', intelligence: 55, speed: 187, price: 1.31, coding: null },
