...
export const CATEGORIES: Record<string, Category> = {
  ai: { key: 'ai', label: 'AI', color: 'oklch(52% 0.2 292)', soft: 'oklch(95% 0.04 292)' },
...
const TAG_MAP: Array<[RegExp, string]> = [
  [/\b(ai|llm|gpt|claude|gemini|ml|machine.?learning|딥러닝|머신러닝|에이전트|agent|rag|mcp|vllm|vector|임베딩|모델)\b/i, 'ai'],
