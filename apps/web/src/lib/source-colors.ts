...
export const SOURCE_DOT: Record<string, string> = {
  ...
  simonwillison: 'oklch(56% 0.09 65)',
  latentspace: 'oklch(56% 0.09 65)',
  importai: 'oklch(54% 0.13 200)',
  // FE/웹 거물 블로그
  overreacted: 'oklch(60% 0.18 25)',
  josh_comeau: 'oklch(58% 0.09 65)',
  kent_dodds: 'oklch(56% 0.09 65)',
  isquared: 'oklch(58% 0.09 65)',
  ...
  mdn: 'oklch(52% 0.09 65)',
  pragmatic: 'oklch(54% 0.12 230)',
  rss_generic: 'oklch(56% 0.09 65)',
};
